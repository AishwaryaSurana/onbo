...
// This screen is intentionally DARK (matches the video paywall).
const D = {
  text: '#FFFFFF',
...
/** Step 6 — contextual paywall. Multi-plan, scrollable social proof + reviews. */
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        <Pressable onPress={next} hitSlop={12} style={styles.close}>
                ...
                <View key={p.id}>
                  ...
                  <Pressable
                    ...
                    style={[
                      ...
                      p.badge && active && styles.planWithTab,
                    ]}>
        ...
        <View style={styles.footer}>
          <Pressable onPress={buy} disabled={busy === 'buy'} style={styles.cta}>
            <Text style={styles.ctaTxt}>{busy === 'buy' ? 'Processing…' : 'Continue'}</Text>
          </Pressable>
